...
urlpatterns += [
    path('api/posts/', CommunityPostListCreateAPIView.as_view(), name='api-community-posts'),
    path('api/posts/<int:post_id>/comments/', CommunityCommentListCreateAPIView.as_view(), name='api-community-comments'),
    path('api/posts/<int:post_id>/like/', CommunityLikeAPIView.as_view(), name='api-community-like'),
]